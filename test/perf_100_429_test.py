...
@pytest.mark.parametrize("load_cnf_files", ["perf-tests/random-3-cnf-100-429"], indirect=True)
class TestPerf:
    def test_dpll_performance(self, load_cnf_files):
        print("Executing perftest testset n=100, m=429:")
        ...
        print()
        print(f"Average execution time for testset n=100, m=429: {average_time:11f} seconds")
